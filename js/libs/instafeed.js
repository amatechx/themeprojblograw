/*
 * Instagram Feed Library - CoffeeScript Generated
    ...
    e = function() {
        ...
        return e.prototype.hasNext = function() {
            ...
            if (typeof document != "undefined" && document !== null && this.options.mock === !1) {
                ...
                var e, t, n;
                e = "https://api.instagram.com/v1", this.options.get === "popular" ? t = "media/popular" : this.options.get === "tagged" ? typeof this.options.tagName != "string" ? t = "media/popular" : t = "tags/" + this.options.tagName + "/media/recent" : this.options.get === "location" ? typeof this.options.locationId != "number" ? t = "media/popular" : t = "locations/" + this.options.locationId + "/media/recent" : this.options.get === "user" && (typeof this.options.userId != "number" ? t = "media/popular" : (typeof this.options.accessToken != "string" && (t = "media/popular"), t = "users/" + this.options.userId + "/media/recent")), n = "" + e + "/" + t, this.options.accessToken != null ? n += "?access_token=" + this.options.accessToken : n += "?client_id=" + this.options.clientId, this.options.limit != null && (n += "&count=" + this.options.limit), n += "&callback=instafeedCache" + this.unique + ".parse", n
